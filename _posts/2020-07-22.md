...
4.3 mini-batch sizes
매우 큰 mini-batches가 최적화와 end-task performance 모두에 뛰어남
미니배치가 크면 MLM의 perplexity, end-task Perf가 향상.

5 RoBERTa (Robustly optimizer BERT approah): dynamic maksing, FULL-SENTENCES wwithout NSP, large mini-batches, laeger byre-level BPE
